...
def train(
    ...
    print('train_texts  '  + str(len(train_texts)))
    print('train_labels  ' +str(len(train_labels)))
    print('dev_texts  ' + str(len(dev_texts)))
    print('dev_labels  '+ str(len(dev_labels)))
    
    print("Loading spaCy")
    nlp = spacy.load("./en_vectors_web_lg/en_vectors_web_lg-2.1.0")
...
def read_train(data_dir, limit=0):
    
    #here hardcode the dir
...
def read_test(data_dir, limit=0):
...
def main(
    ...
    if is_runtime:
        if dev_dir is None:
            ...
            dev_texts, dev_labels = read_test(dev_dir)
        ...
        if train_dir is None:
            ...
            print("Read data")
            train_texts, train_labels = read_train(train_dir, limit=nr_examples)
        if dev_dir is None:
            dev_texts, dev_labels = zip(*imdb_data[1])
        else:
            dev_texts, dev_labels = read_test(dev_dir, limit=nr_examples)
